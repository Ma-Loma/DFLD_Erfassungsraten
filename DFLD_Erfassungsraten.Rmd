...
```{r Scatterplots1f, fig.cap="Graphische Darstellung der Daten nach Fangradius", fig.width=6.7,fig.height=5.5}
...
#Bei Zeitumstellung ist die Dauer länger oder kürzer
DENIntervalle(
    dmy("29.03.2025"),
    dmy("30.03.2025"))
...
DauernInIntervallen(eins,zwei,"Spaß")
...
stat <-
  ...
  group_by(StatNam, Fangradius,DEN) %>%
  summarise(
    n1 = sum(StatusNr == 0),
    n2 = n(),
...
Dauerschallpegel aller Flieger
...
stat %>% 
  ...
  geom_line()+
  facet_grid(cols=vars(StatNam),rows=vars(`Größe`))
