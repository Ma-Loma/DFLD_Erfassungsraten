...
```{r Messchwellenverlauf, fig.cap="Graphische Darstellung der Messschwelle als Funktion der Tagesstunde.", fig.width=6.7,fig.height=4}
...
full_praef %>% 
  ...
  ggsave("Status gleich 0 LASmax(Calc).png",dpi=300)
...
full_praef %>% 
  ...
  ggsave("Status ungleich 0 LASmax(Calc).png",dpi=300)
...
full_praef %>% 
  ...
  ggsave("Status ungleich 0 LASmax(Mess).png",dpi=300)
...
full_praef %>% 
  ...
  ggsave("Status gleich 0 LASmax(Mess).png",dpi=300)
