...
Welcher Einfluss haben der Fangradius und weitere Parameter auf die Erfassungsrate der DFLD-Messstationen.
...
In Abb. \@ref(fig:n1n2) werden n1 und n2 dargestellt. Der von Herrn Weise präferierte Fangradius ist jeweils mit einer senkrechten Linie markiert.
...
In Abb. \@ref(fig:Leq) sind die Erfassungsquoten dargestellt.  Der von Herrn Weise präferierte Fangradius ist jeweils mit einer senkrechten Linie markiert.
...
```{r Anzahl_gleichzeitig, tab.id = "AnzahlGleichzeitig", tab.cap="Graphische Darstellung der Erfassungsquote nach Gewichtsklasse. Dabei steht erk für akustisch erkannt, unerk für akustisch nicht erkannt, gleichz für gleichzeitige Ereignise und einz für einzelne, nicht gleichzeitige Ereignisse."}
