...
In Abb. \@ref(fig:n1n2) werden n1 und n2 dargestellt. Der von Herrn Weise präferierte Fangradius ist jeweils mit einer senkrechten Linie markiert. Hier ist zu erkennen, dass in Frankfurt/Gallus bis 3500 m fast keine Heavies vorbeifliege - der Grund liegt darin, dass die Abflugroute "07 Nord kurz" standardmäßig für Heavies gesperrt ist.
...
```{r Erfassungsquote24h, fig.cap="Graphische Darstellung der Erfassungsquote nach Gewichtsklasse.", fig.width=6.7,fig.height=5.5}
